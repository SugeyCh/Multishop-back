...
exports.verifyUser = exports.userLogout = exports.loginUser = exports.getUsers = exports.authLogin = void 0;
...
var getUsers = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var bd, _yield$bd$query, _yield$bd$query2, rows;
...
var verifyUser = function verifyUser(req, res, next) {
  try {
    ...
    if (!_token) {
      ...
      _jsonwebtoken["default"].verify(_token, "clave-secreta", function (err, decoded) {
        if (err) {
          return res.json({
...
var loginUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var bd, _req$body, nombre, contrasena, _yield$bd$query3, _yield$bd$query4, results, user, _nombre, _token2;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          _context2.next = 7;
          return bd.query("SELECT * FROM devices WHERE nombre = ?", [nombre]);
        case 7:
          _yield$bd$query3 = _context2.sent;
          _yield$bd$query4 = _slicedToArray(_yield$bd$query3, 1);
          results = _yield$bd$query4[0];
          console.log(results);
        ...
        case 30:
          ...
          console.log("Error al loguear: ", _context2.t0);
        case 33:
        case "end":
